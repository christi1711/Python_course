...
def picture(environ, start_response):
    start_response('200 OK', [('Content-type', 'text/html')])
    resp = _img_resp.format(img_net='https://pngriver.com/wp-content/uploads/2017/11/balloon-free-PNG-transparent-background-images-free-download-clipart-pics-8cxrMxe6i.png')
    yield resp.encode('utf-8')
